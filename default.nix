...
, filepath, glpk-hs, graphviz, labeled-tree, lens, mtl, parsek
, polynomials-bernstein, pretty, process, stdenv, text
...
mkDerivation {
  ...
  buildDepends = [
    ...
    graphviz labeled-tree lens mtl parsek polynomials-bernstein pretty
